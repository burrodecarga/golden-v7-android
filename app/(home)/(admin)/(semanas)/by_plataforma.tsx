...
import { useServiciosBySemanaAndPlataforma } from '@/hooks/useServiciosBySemanaAndPlataforma'
import { useLocalSearchParams } from 'expo-router'
import React, { useState } from 'react'
import { FlatList, ScrollView, StyleSheet, Text, TouchableOpacity, View } from 'react-native'

const SemanaByPlataformaScreen=() => {
    const { semana, plataforma }=useLocalSearchParams()
    const { data: servicios, error, isLoading }=useServiciosBySemanaAndPlataforma(Number(semana), plataforma as string)
...
export default SemanaByPlataformaScreen
